    ...
    return(
        ...
        <div className="sm:w-1/2 w-3/4 h-[70%] flex flex-col items-center justify-around ">
                ...
                <div className="flex justify-between items-center overflow-hidden">
                    <img  className="logos h-[40px] w-[40px]" src={html5} />
                    <img  className="logos h-[40px] w-[40px]" src={css3} />
                    <img  className="logos h-[40px] w-[40px]" src={js}/>
                    <img  className="logos h-[40px] w-[40px]" src={react}/>
                    <img  className="logos h-[40px] w-[40px]" src={tailwind}/>
                    <img  className="logos h-[40px] w-[40px]" src={git} />
                    <img  className="logos h-[40px] w-[40px]" src={github}/>
                </div>
                <div className="flex justify-between items-center text-amber-50">
                    <p className="names w-[40px] m-0 text-[0.6em]  font-nunito text-center">HTML5</p>
                    <p className="names w-[40px] m-0 text-[0.6em] font-nunito text-center">CSS3</p>
                    <p className="names w-[40px] m-0 text-[0.6em] font-nunito text-center">JS</p>
                    <p className="names w-[40px] m-0 text-[0.6em] font-nunito text-center">REACT</p>
                    <p className="names w-[40px] m-0 text-[0.6em] font-nunito text-center">TAILWIND</p>
                    <p className="names w-[40px] m-0 text-[0.6em] font-nunito text-center">GIT</p>
                    <p className="names w-[40px] m-0 text-[0.6em] font-nunito text-center">GITHUB</p>
                </div>
                </div>
        </div>
    </section>
