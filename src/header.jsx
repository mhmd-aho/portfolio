...
function Header(){
  ...
  const lettersRef = useRef([]);
    ...
    <header  className="fixed top-0 left-0 sm:px-2 px-1 flex gap-14 sm:justify-between items-center w-full h-12 bg-black z-1">
        <h4 ref={textRef} className="text-[12px]/5 sm:text-xl/5  font-nunito cursor-default font-extrabold m-0 text-amber-400">MOHAMED <br/> ABOU HAMOUD</h4>
        <nav className="w-3/5 sm:w-1/3 flex items-center justify-between text-[10px] lg:text-base  text-amber-50 font-nunito">
            <Contacts />
